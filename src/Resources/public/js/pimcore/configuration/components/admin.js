...
pimcore.registerNS("pimcore.plugin.storeExporterDataObject.configuration.components.admin");

pimcore.plugin.storeExporterDataObject.configuration.components.admin = Class.create({
