...
pimcore.registerNS('pimcore.plugin.storeExporterDataObject.configuration.components.logTab');
...
pimcore.plugin.storeExporterDataObject.configuration.components.logTab = Class.create(baseClass, {
    ...
    getTabPanel: function($super) {
        ...
        this.panel.setTitle(t('plugin_pimcore_datahub_configpanel_item_logs'));
