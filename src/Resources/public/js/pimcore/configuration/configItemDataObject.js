pimcore.registerNS(
  "pimcore.plugin.storeExporterDataObject.configuration.configItemDataObject"
);
pimcore.plugin.storeExporterDataObject.configuration.configItemDataObject =
  Class.create(pimcore.plugin.datahub.configuration.graphql.configItem, {
    config: {
      attributeStore: null,
      objectTree: null,
      configName: null,
        ...
        items: [
          {
            ...
            inputValue: true,
            value:
              this.data.general && this.data.general.hasOwnProperty("active")
        ...
        this.localAttributesStore = Ext.create("Ext.data.Store", {
          ...
          proxy: {
            ...
            url: Routing.generate(
              "pimcore_storesyndicator_attributes_get_local"
            ),
            noCache: false,
            type: "ajax",
            root: "result",
      ...
      if (!this.remoteAttributeTypeStore) {
        this.remoteAttributeTypeStore = Ext.create("Ext.data.Store", {
          ...
          proxy: {
            method: "GET",
            url: Routing.generate(
              "pimcore_storesyndicator_attributes_get_remote_types"
            ),
            noCache: false,
            type: "ajax",
            root: "result",
      ...
      if (!this.remoteAttributesStore) {
        this.remoteAttributesStore = Ext.create("Ext.data.Store", {
          ...
          proxy: {
            method: "GET",
            url: Routing.generate(
              "pimcore_storesyndicator_attributes_get_remote"
            ),
            noCache: false,
            type: "ajax",
            root: "result",
      ...
      grid = Ext.create("Ext.grid.Panel", {
        ...
        viewConfig: {
          plugins: {
            ...
            dragGroup: t(
              "plugin_pimcore_datahub_configpanel_item_attribute_mapping"
            ),
            dropGroup: t(
              "plugin_pimcore_datahub_configpanel_item_attribute_mapping"
            ),
        ...
        columns: [
          ...
          },
          {
            ...
            items: [
              {
                iconCls:
                  "plugin_pimcore_datahub_icon_storeExporterDataObject_delete_row",
                tooltip: "Delete",
    ...
    buildAccessTab: function () {
      if (!this.APIAccessPicker) {
        this.APIAccessPicker =
          new pimcore.plugin.storeExporterDataObject.helpers.workspace.apiObjects(
            this
          );
      }
